...
func TestMigrateSchemaV4AddsResourceUploadKeyToExistingSchema(t *testing.T) {
	...
	if err := db.AutoMigrate(&model.ModelChannel{}, &model.ChannelModel{}, &model.BillingOrder{}); err != nil {
		t.Fatal(err)
	}
...
func TestMigrateSchemaRepairsLegacyAssetFoldersMigrationOrder(t *testing.T) {
	...
	if err := db.AutoMigrate(&model.Resource{}, &model.Asset{}, &model.AssetFolder{}, &model.ModelChannel{}, &model.ChannelModel{}, &model.BillingOrder{}); err != nil {
		t.Fatal(err)
	}
	if err := db.AutoMigrate(&schemaMigration{}); err != nil {
		t.Fatal(err)
